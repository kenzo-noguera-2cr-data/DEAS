...
def transform_csv(input_filename):
    ...
    output_filename = os.path.join(directory, f"{listing_name}_OMNI_Data.csv")

    # Load the input CSV
    input_df = pd.read_csv(input_filename)

    # Load the translation CSV
    translation_df = pd.read_csv("OMNI_Translation.csv")
    ...
    merged_df["ATTRIBUTE"] = merged_df["OMNI_IDS"]
    ...
    additional_rows_df = pd.read_csv('OMNI_mls_fixed_data.csv')
    ...
    value_type_dict = pd.read_csv("OMNI_VALUE_TYPE_DICT.csv")
